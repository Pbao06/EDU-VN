  ...
  return (
    <div className="relative min-w-[9.5rem] flex-1 sm:min-w-[10.5rem]" ref={containerRef}>
      <button
        ...
        aria-expanded={open}
        aria-label={label}
        className="cursor-pointer flex w-full items-center gap-2 rounded-xl border-2 border-black bg-white px-3 py-2.5 text-left transition-transform duration-150 focus:outline-none focus:ring-2 focus:ring-blue-600"
        style={{
